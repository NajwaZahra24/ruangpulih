                ...
                <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="category" name="category" required>
                            <option value="edukasi" {{ $post->category == 'edukasi' ? 'selected' : '' }}>Edukasi Kesehatan Mental</option>
                            <option value="informasi" {{ $post->category == 'informasi' ? 'selected' : '' }}>Informasi Kesehatan Mental</option>
                        </select>
                    </div>
