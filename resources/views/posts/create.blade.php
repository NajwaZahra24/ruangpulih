                ...
                <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="category" name="category" required>
                            ...
                            <option value="edukasi">Edukasi Kesehatan Mental</option>
                            <option value="informasi">Informasi Kesehatan Mental</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="published_at" class="form-label">Tanggal Publikasi (Kosongkan untuk simpan sebagai draft)</label>
